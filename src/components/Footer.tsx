        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/about" className="text-gray-300 hover:text-lavender transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/offerings" className="text-gray-300 hover:text-lavender transition-colors">
                  Our Offerings
                </Link>
              </li>
              <li>
                <Link to="/events" className="text-gray-300 hover:text-lavender transition-colors">
                  Events & Workshops
                </Link>
              </li>
              <li>
                <Link to="/testimonials" className="text-gray-300 hover:text-lavender transition-colors">
                  Testimonials
                </Link>
              </li>
              <li>
                <Link to="/blog" className="text-gray-300 hover:text-lavender transition-colors">
                  Blog
                </Link>
              </li>
              <li>
                <Link to="/join-us" className="text-gray-300 hover:text-lavender transition-colors">
                  Join Us / Volunteer
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/privacy" className="text-gray-300 hover:text-lavender transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link to="/terms" className="text-gray-300 hover:text-lavender transition-colors">
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link to="/careers" className="text-gray-300 hover:text-lavender transition-colors">
                  Careers
                </Link>
              </li>
              <li>
                <Link to="/faq" className="text-gray-300 hover:text-lavender transition-colors">
                  FAQ
                </Link>
              </li>
            </ul>
